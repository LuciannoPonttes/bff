...
import com.porto.bff.conta.gerenciar.bffcontadigitalgerenciar.application.core.domain.porto.AccountBlockingPoliciesEnum;
...
class PoliticasBloqueioContaEnumTest {
    ...
    public void testPermiteCashIn_AllowWhenPolicyDoesNotExists() {
        ...
        assertTrue(AccountBlockingPoliciesEnum.permiteCashIn(flagsPolicies));
    }
    ...
    public void testPermiteCashOut_AllowWhenPolicyDoesNotExists() {
        ...
        assertTrue(AccountBlockingPoliciesEnum.permiteCashOut(flagsPolicies));
    }
    ...
    public void deveSerFalsoQuandoObitoEBloqueioJudicialTemAoMenosUmValorFalso() {
        ...
        assertFalse(AccountBlockingPoliciesEnum.permiteCashIn(flagsPolicies));
        assertFalse(AccountBlockingPoliciesEnum.permiteCashOut(flagsPolicies));
    }
