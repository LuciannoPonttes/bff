...
ADD target/bff-conta-digital-gerenciamento.jar .
...
ENTRYPOINT ["sh", "-c", "java $JAVA_OPTIONS -Djava.security.egd=file:/dev/./urandom -jar bff-conta-digital-gerenciamento.jar"]
